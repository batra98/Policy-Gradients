...
class Vannilla_Policy_Gradient(nn.Module):
	def __init__(self,state_space,action_space,max_action,hidden_size = 256):
...
class CartPole_agent:
	...
	def __init__(self,env,learning_rate = 3e-4,gamma = 0.99):
		...
		self.gamma = gamma
		self.policy = Vannilla_Policy_Gradient(self.state_space,self.action_space,float(env.action_space.high[0]))
